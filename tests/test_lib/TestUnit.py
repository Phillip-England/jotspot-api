...
class TestUnit:
  ...
  def print_response(self, test_instance):
    self.print_color(self.color_codes['green'] if test_instance.response.status_code == test_instance.status_code_expected else self.color_codes['red'], f'  request result - {"pass" if test_instance.response.status_code == test_instance.status_code_expected else "fail"}')
    ...
    if test_instance.pre_execution_callback != None:
      print(f'  pre exectuion callback')
      print(f'    purpose - {test_instance.pre_execution_callback.purpose}')
      self.print_color(self.color_codes['green'] if test_instance.pre_execution_callback.outcome == test_instance.pre_execution_callback.expected_result else self.color_codes['red'], f'    pre exection callback result - {"pass" if test_instance.pre_execution_callback.outcome == test_instance.pre_execution_callback.expected_result else "fail"}')
    if test_instance.post_execution_callback != None:
      print(f'  post execution callback')
      print(f'    purpose - {test_instance.post_execution_callback.purpose}')
      self.print_color(self.color_codes['green'] if test_instance.post_execution_callback.outcome == test_instance.post_execution_callback.expected_result else self.color_codes['red'], f'    post exection callback result - {"pass" if test_instance.post_execution_callback.outcome == test_instance.post_execution_callback.expected_result else "fail"}')
    self.print_color(self.color_codes['blue'], '---------------------------------------')
